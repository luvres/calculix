    ...
    if (e_enqire[i].type == 4)
    {
      ...
      for (n=0; n<3; n++)  
      {
        ...
        node[anz->nmax].nx = -1./4.* (
          node[e_enqire[i].nod[0+n]].nx+node[e_enqire[i].nod[1+n]].nx    +
          node[e_enqire[i].nod[5+n]].nx+node[e_enqire[i].nod[4+n]].nx )  + 1./2.*(
          node[e_enqire[i].nod[8+n]].nx+node[e_enqire[i].nod[13+n]].nx   +
          node[e_enqire[i].nod[16+n]].nx+node[e_enqire[i].nod[12+n]].nx) ;

        node[anz->nmax].ny = -1./4.* (
          node[e_enqire[i].nod[0+n]].ny+node[e_enqire[i].nod[1+n]].ny    +
          node[e_enqire[i].nod[5+n]].ny+node[e_enqire[i].nod[4+n]].ny )  + 1./2.*(
          node[e_enqire[i].nod[8+n]].ny+node[e_enqire[i].nod[13+n]].ny   +
          node[e_enqire[i].nod[16+n]].ny+node[e_enqire[i].nod[12+n]].ny) ;

        node[anz->nmax].nz = -1./4.* (
          node[e_enqire[i].nod[0+n]].nz+node[e_enqire[i].nod[1+n]].nz    +
          node[e_enqire[i].nod[5+n]].nz+node[e_enqire[i].nod[4+n]].nz )  + 1./2.*(
          node[e_enqire[i].nod[8+n]].nz+node[e_enqire[i].nod[13+n]].nz   +
          node[e_enqire[i].nod[16+n]].nz+node[e_enqire[i].nod[12+n]].nz) ;

        e_enqire[i].nod[n+20]=node[anz->n].nr;
        anz->n++;
      }
        anz->nmax++;
        node[anz->n].nr = anz->nmax;
        ...
        node[anz->nmax].nx = -1./4.* (
          node[e_enqire[i].nod[3]].nx+node[e_enqire[i].nod[0]].nx    +
          node[e_enqire[i].nod[4]].nx+node[e_enqire[i].nod[7]].nx )  + 1./2.*(
          node[e_enqire[i].nod[11]].nx+node[e_enqire[i].nod[12]].nx   +
          node[e_enqire[i].nod[19]].nx+node[e_enqire[i].nod[15]].nx) ;

        node[anz->nmax].ny = -1./4.* (
          node[e_enqire[i].nod[3]].ny+node[e_enqire[i].nod[0]].ny    +
          node[e_enqire[i].nod[4]].ny+node[e_enqire[i].nod[7]].ny )  + 1./2.*(
          node[e_enqire[i].nod[11]].ny+node[e_enqire[i].nod[12]].ny   +
          node[e_enqire[i].nod[19]].ny+node[e_enqire[i].nod[15]].ny) ;

        node[anz->nmax].nz = -1./4.* (
          node[e_enqire[i].nod[3]].nz+node[e_enqire[i].nod[0]].nz    +
          node[e_enqire[i].nod[4]].nz+node[e_enqire[i].nod[7]].nz )  + 1./2.*(
          node[e_enqire[i].nod[11]].nz+node[e_enqire[i].nod[12]].nz   +
          node[e_enqire[i].nod[19]].nz+node[e_enqire[i].nod[15]].nz) ;

        e_enqire[i].nod[23]=node[anz->n].nr;
        anz->n++;
      ...
      for (n=0; n<2; n++) 
      {
        ...
        n2=n*8;
        node[anz->nmax].nx = -1./4.* (
          node[e_enqire[i].nod[0+n1]].nx+node[e_enqire[i].nod[1+n1]].nx    +
          node[e_enqire[i].nod[2+n1]].nx+node[e_enqire[i].nod[3+n1]].nx )  + 1./2.*(
          node[e_enqire[i].nod[8+n2]].nx+node[e_enqire[i].nod[9+n2]].nx   +
          node[e_enqire[i].nod[10+n2]].nx+node[e_enqire[i].nod[11+n2]].nx) ;

        node[anz->nmax].ny = -1./4.* (
          node[e_enqire[i].nod[0+n1]].ny+node[e_enqire[i].nod[1+n1]].ny    +
          node[e_enqire[i].nod[2+n1]].ny+node[e_enqire[i].nod[3+n1]].ny )  + 1./2.*(
          node[e_enqire[i].nod[8+n2]].ny+node[e_enqire[i].nod[9+n2]].ny   +
          node[e_enqire[i].nod[10+n2]].ny+node[e_enqire[i].nod[11+n2]].ny) ;

        node[anz->nmax].nz = -1./4.* (
          node[e_enqire[i].nod[0+n1]].nz+node[e_enqire[i].nod[1+n1]].nz    +
          node[e_enqire[i].nod[2+n1]].nz+node[e_enqire[i].nod[3+n1]].nz )  + 1./2.*(
          node[e_enqire[i].nod[8+n2]].nz+node[e_enqire[i].nod[9+n2]].nz   +
          node[e_enqire[i].nod[10+n2]].nz+node[e_enqire[i].nod[11+n2]].nz) ;

        e_enqire[i].nod[n+24]=node[anz->n].nr;
        anz->n++;
      }
    }
    if (e_enqire[i].type == 5)
    {
      ...
      for (n=0; n<2; n++)  
      {
        ...
        node[anz->nmax].nx = -1./4.* (
          node[e_enqire[i].nod[0+n]].nx+node[e_enqire[i].nod[1+n]].nx    +
          node[e_enqire[i].nod[4+n]].nx+node[e_enqire[i].nod[3+n]].nx )  + 1./2.*(
          node[e_enqire[i].nod[6+n]].nx+node[e_enqire[i].nod[10+n]].nx   +
          node[e_enqire[i].nod[12+n]].nx+node[e_enqire[i].nod[ 9+n]].nx) ;

        node[anz->nmax].ny = -1./4.* (
          node[e_enqire[i].nod[0+n]].ny+node[e_enqire[i].nod[1+n]].ny    +
          node[e_enqire[i].nod[4+n]].ny+node[e_enqire[i].nod[3+n]].ny )  + 1./2.*(
          node[e_enqire[i].nod[6+n]].ny+node[e_enqire[i].nod[10+n]].ny   +
          node[e_enqire[i].nod[12+n]].ny+node[e_enqire[i].nod[ 9+n]].ny) ;

        node[anz->nmax].nz = -1./4.* (
          node[e_enqire[i].nod[0+n]].nz+node[e_enqire[i].nod[1+n]].nz    +
          node[e_enqire[i].nod[4+n]].nz+node[e_enqire[i].nod[3+n]].nz )  + 1./2.*(
          node[e_enqire[i].nod[6+n]].nz+node[e_enqire[i].nod[10+n]].nz   +
          node[e_enqire[i].nod[12+n]].nz+node[e_enqire[i].nod[ 9+n]].nz) ;

        e_enqire[i].nod[n+15]=node[anz->n].nr;
        anz->n++;
      }
        anz->nmax++;
        node[anz->n].nr = anz->nmax;
        ...
        node[anz->nmax].nx = -1./4.* (
          node[e_enqire[i].nod[2]].nx+node[e_enqire[i].nod[0]].nx    +
          node[e_enqire[i].nod[3]].nx+node[e_enqire[i].nod[5]].nx )  + 1./2.*(
          node[e_enqire[i].nod[ 8]].nx+node[e_enqire[i].nod[ 9]].nx   +
          node[e_enqire[i].nod[14]].nx+node[e_enqire[i].nod[11]].nx) ;

        node[anz->nmax].ny = -1./4.* (
          node[e_enqire[i].nod[2]].ny+node[e_enqire[i].nod[0]].ny    +
          node[e_enqire[i].nod[3]].ny+node[e_enqire[i].nod[5]].ny )  + 1./2.*(
          node[e_enqire[i].nod[ 8]].ny+node[e_enqire[i].nod[ 9]].ny   +
          node[e_enqire[i].nod[14]].ny+node[e_enqire[i].nod[11]].ny) ;

        node[anz->nmax].nz = -1./4.* (
          node[e_enqire[i].nod[2]].nz+node[e_enqire[i].nod[0]].nz    +
          node[e_enqire[i].nod[3]].nz+node[e_enqire[i].nod[5]].nz )  + 1./2.*(
          node[e_enqire[i].nod[ 8]].nz+node[e_enqire[i].nod[ 9]].nz   +
          node[e_enqire[i].nod[14]].nz+node[e_enqire[i].nod[11]].nz) ;

        e_enqire[i].nod[17]=node[anz->n].nr;
        anz->n++;
        ...
        node[anz->nmax].nx = -1./4.* (
          node[e_enqire[i].nod[0]].nx+node[e_enqire[i].nod[2]].nx    +
          node[e_enqire[i].nod[1]].nx+node[e_enqire[i].nod[0]].nx )  + 1./2.*(
          node[e_enqire[i].nod[ 8]].nx+node[e_enqire[i].nod[ 7]].nx   +
          node[e_enqire[i].nod[ 6]].nx+node[e_enqire[i].nod[ 0]].nx) ;

        node[anz->nmax].ny = -1./4.* (
          node[e_enqire[i].nod[0]].ny+node[e_enqire[i].nod[2]].ny    +
          node[e_enqire[i].nod[1]].ny+node[e_enqire[i].nod[0]].ny )  + 1./2.*(
          node[e_enqire[i].nod[ 8]].ny+node[e_enqire[i].nod[ 7]].ny   +
          node[e_enqire[i].nod[ 6]].ny+node[e_enqire[i].nod[ 0]].ny) ;

        node[anz->nmax].nz = -1./4.* (
          node[e_enqire[i].nod[0]].nz+node[e_enqire[i].nod[2]].nz    +
          node[e_enqire[i].nod[1]].nz+node[e_enqire[i].nod[0]].nz )  + 1./2.*(
          node[e_enqire[i].nod[ 8]].nz+node[e_enqire[i].nod[ 7]].nz   +
          node[e_enqire[i].nod[ 6]].nz+node[e_enqire[i].nod[ 0]].nz) ;

        e_enqire[i].nod[18]=node[anz->n].nr;
        anz->n++;
        ...
        node[anz->nmax].nx = -1./4.* (
          node[e_enqire[i].nod[3]].nx+node[e_enqire[i].nod[4]].nx    +
          node[e_enqire[i].nod[5]].nx+node[e_enqire[i].nod[3]].nx )  + 1./2.*(
          node[e_enqire[i].nod[12]].nx+node[e_enqire[i].nod[13]].nx   +
          node[e_enqire[i].nod[14]].nx+node[e_enqire[i].nod[ 3]].nx) ;

        node[anz->nmax].ny = -1./4.* (
          node[e_enqire[i].nod[3]].ny+node[e_enqire[i].nod[4]].ny    +
          node[e_enqire[i].nod[5]].ny+node[e_enqire[i].nod[3]].ny )  + 1./2.*(
          node[e_enqire[i].nod[12]].ny+node[e_enqire[i].nod[13]].ny   +
          node[e_enqire[i].nod[14]].ny+node[e_enqire[i].nod[ 3]].ny) ;

        node[anz->nmax].nz = -1./4.* (
          node[e_enqire[i].nod[3]].nz+node[e_enqire[i].nod[4]].nz    +
          node[e_enqire[i].nod[5]].nz+node[e_enqire[i].nod[3]].nz )  + 1./2.*(
          node[e_enqire[i].nod[12]].nz+node[e_enqire[i].nod[13]].nz   +
          node[e_enqire[i].nod[14]].nz+node[e_enqire[i].nod[ 3]].nz) ;

        e_enqire[i].nod[19]=node[anz->n].nr;
        anz->n++;
    }
    if (e_enqire[i].type == 10)
    {
      ...
      node[anz->nmax].indx=anz->n;
        ...
        node[anz->nmax].nx = -1./4.* (
          node[e_enqire[i].nod[0]].nx+node[e_enqire[i].nod[1]].nx  +
          node[e_enqire[i].nod[3]].nx+node[e_enqire[i].nod[2]].nx )+ 1./2.*(
          node[e_enqire[i].nod[4]].nx+node[e_enqire[i].nod[6]].nx  +
          node[e_enqire[i].nod[7]].nx+node[e_enqire[i].nod[5]].nx) ;

        node[anz->nmax].ny = -1./4.* (
          node[e_enqire[i].nod[0]].ny+node[e_enqire[i].nod[1]].ny  +
          node[e_enqire[i].nod[3]].ny+node[e_enqire[i].nod[2]].ny )+ 1./2.*(
          node[e_enqire[i].nod[4]].ny+node[e_enqire[i].nod[6]].ny  +
          node[e_enqire[i].nod[7]].ny+node[e_enqire[i].nod[5]].ny) ;

        node[anz->nmax].nz = -1./4.* (
          node[e_enqire[i].nod[0]].nz+node[e_enqire[i].nod[1]].nz  +
          node[e_enqire[i].nod[3]].nz+node[e_enqire[i].nod[2]].nz )+ 1./2.*(
          node[e_enqire[i].nod[4]].nz+node[e_enqire[i].nod[6]].nz  +
          node[e_enqire[i].nod[7]].nz+node[e_enqire[i].nod[5]].nz) ;
        e_enqire[i].nod[8]=node[anz->n].nr;
        anz->n++;
    }
  }
